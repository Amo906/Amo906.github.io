...
int main()
{
	vector<string> temp;
	vector<string> name;
	freopen("D:\\Program Files\\Blog\\myblog\\source\\photos\\out.txt","w",stdout);
	getFiles("D:\\Program Files\\Blog\\myblog\\source\\photos", temp,name);
	getFiles1("D:\\Program Files\\Blog\\myblog\\source\\photos", temp,name);
